 ...
 * - 左右对比：并排展示
 */
export const InpaintPreview: React.FC<InpaintPreviewProps> = ({
  originalUrl,
  resultUrl,
  displayWidth,
  displayHeight,
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
      ...
      {mode === 'slider' ? (
        ...
        <div style={{ display: 'flex', gap: '0.5rem' }}>
          ...
          <div style={{ flex: 1, textAlign: 'center' }}>
            <div style={{ fontSize: '0.75rem', color: 'var(--text-muted)', marginBottom: '0.25rem' }}>去水印后</div>
            <img
              src={resultUrl}
              alt="result"
              style={{ width: '100%', maxHeight: displayHeight, objectFit: 'contain', borderRadius: 'var(--radius-md)' }}
